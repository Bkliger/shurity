...
question_4 = Question.create(category_id: cat_1.id, text: 'Speakerphone capable?', presentation_type: 'select')
question_5 = Question.create(category_id: cat_1.id, text: 'How important is durability?', presentation_type: 'reg-slider')
question_6 = Question.create(category_id: cat_1.id, text: 'Does the sound need to go in all directions?', presentation_type: 'select')
...
question_10 = Question.create(category_id: cat_1.id, text: 'Color', presentation_type: 'select')
